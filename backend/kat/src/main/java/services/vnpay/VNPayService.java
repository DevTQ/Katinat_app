...
public class VNPayService implements IVNPayService {
    ...
    @Override
    public String createPaymentUrl(PaymentDTO paymentDto, HttpServletRequest httpRequest) throws DataNotFoundException {
        ...
        Order order = orderRepository.findById(paymentDto.getOrderId())
                .orElseThrow(() -> new DataNotFoundException("Cannot find order with id: " + paymentDto.getOrderId()));
        ...
        String returnUrl = UriComponentsBuilder
                .fromHttpUrl(baseUrl)
                .path(vnPayConfig.getReturnPath())
                .toUriString();
