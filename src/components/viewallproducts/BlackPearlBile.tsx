        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.header}>
                    <ImageBackground 
                        source={require('../../../assets/images/imageproducts/hc_duong_mat.jpg')} 
                        style={styles.image} 
                    />
                    <Text style={styles.title}>Huyền Châu Đường Mật (L)</Text>
