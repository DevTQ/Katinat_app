...
const olongThreeTea = () => {
    ...
    const [priceProduct, setPriceProduct] = useState(54000);
    ...
    const setNumberOfProduct = (action: "increase" | "decrease") => {
        setNumOfProduct(prevNum => {
            ...
            const newProductPrice = newNum * 54000;
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.header}>
                    <ImageBackground 
                        source={require('../../../assets/images/imageproducts/bala.jpg')} 
                        style={styles.image} 
                    />
                    <Text style={styles.title}>Oolong Ba Lá (L)</Text>
                    <Text numberOfLines={6} style={styles.description}>
                        Oolong Ba Lá mang đến hương vị Trà Sữa Oolong đậm đà, thuần khiết 
                        , thơm thanh hương hoa cỏ, với mỗi ngụm trà là hành trình khám phá 
                        phong vị mới, đưa Katies bước vào thế giới thưởng thức đặc sắc của 
                        Trà Sữa Oolong. Thành phần: Trà Oolong ba lá, Sữa đặc, Đá
                    </Text>
                </View>
