        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.header}>
                    <ImageBackground 
                        source={require('../../../assets/images/imageproducts/dau_mai_son.jpg')} 
                        style={styles.image} 
                    />
                    <Text style={styles.title}>Oolong Dâu Mai Sơn (L)</Text>
                    <Text numberOfLines={6} style={styles.description}>
                        Trà Oolong Dâu Mai Sơn là sự kết hợp hoàn hảo giữa vị trà
                        Oolong tinh tế hảo hạng và 100% dâu được xay tươi chín mong
                        đỏ ngọt. Thức uống mang lại cảm giác tươi mới và sảng khoái
                        hơn bao giờ hết bởi vị chua ngọt mượt mà hòa quyện cùng Thạch
                        Hồng Đài dẻo dẻo dai dai, bắt vị. Thành phần: Trà oolong, Dâu,
                        Chanh, Hồng đài, Đá.
                    </Text>
                </View>
...
export default olongStrawberry;