        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.header}>
                    <ImageBackground 
                        source={require('../../../assets/images/imageproducts/hc_bo_sua.jpg')} 
                        style={styles.image} 
                    />
                    <Text style={styles.title}>Huyền Châu Bơ Sữa (L)</Text>
                    <Text numberOfLines={6} style={styles.description}>
                        Sự kết hợp của Huyền Châu dai dẻo, áo màu đường nâu thấm
                        đấm cùng sữa tươi thanh béo thượng hạng và lớp bơ mịn màng
                        phủ bên trên chính là điểm nhấn sáng tạo mà KATINAT muống mang lại
                    </Text>
                </View>
...
export default blackPearlAvocadoMilk;