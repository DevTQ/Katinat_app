            ...
            <View>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    <View style={{ flexDirection: 'row' }}>
                        <Text style={{ marginLeft: 15, fontWeight: 'bold', marginRight: 3, fontSize: 18,color: '#104358',fontFamily: 'Open Sans Condensed' }}>
                            DÀNH CHO BẠN
                        </Text>
                    </View>
                    <TouchableOpacity
                        activeOpacity={1} 
                        onPress={() => navigation.navigate("ViewAllForYou")}
                    >
