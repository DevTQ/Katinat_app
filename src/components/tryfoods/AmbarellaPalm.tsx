        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.header}>
                    <ImageBackground source={require("../../../assets/images/imageproducts/coccoc_dacdac.jpg")} style={styles.image} resizeMode="cover" />
                    <Text style={styles.title}>{`Cóc Cóc Đác Đác ${sizeTitle}`}</Text>
