        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.header}>
                    <ImageBackground source={require("../../../assets/images/imageproducts/Bogia_duanon.jpg")} style={styles.image} resizeMode="cover" />
                    <Text style={styles.title}>{`Bơ Già Dừa Non ${sizeTitle}`}</Text>
