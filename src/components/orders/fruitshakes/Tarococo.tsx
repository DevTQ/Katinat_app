        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.header}>
                    <ImageBackground source={require("../../../../assets/images/imageproducts/KMDN.jpg")} style={styles.image} resizeMode="cover" />
                    <Text style={styles.title}>{`TARO COCO ${sizeTitle}`}</Text>
                    <Text numberOfLines={8} style={styles.description}>
                        Taro Coco là sự kết hợp tuyệt vời giữa khoai môn nghiền sánh mịn và sữa dừa non ngọt thanh
                        , mang đến trải nghiệm phong phú vị lạ lạ mà quen quen. Đây là thức uống vui miệng, vừa ăn,
                        vừa uống lai rai với sự dẻo dai của Huyền Châu và giòn giòn của hạt còi điều.
                    </Text>
                </View>
