        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.header}>
                    <ImageBackground source={require("../../../../assets/images/imageproducts/hc_duong_mat.jpg")} style={styles.image} resizeMode="cover" />
                    <Text style={styles.title}>{`Huyền Châu Đường Mật ${sizeTitle}`}</Text>
                    <Text numberOfLines={8} style={styles.description}>
                        Thức uống kinh điển một thời nay đã được KATINAT nâng tầm hương vị bằng những nguyên liệu 
                        thượng hạng. Huyền Châu Đường Mật là sự kết hợp hài hòa của sữa tươi thanh béo và Huyền 
                        Châu áo màu "đường mật" thấm đẫm.
                    </Text>
                </View>
