        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.header}>
                    <ImageBackground source={require("../../../../assets/images/imageproducts/mexiu.jpg")} style={styles.image} resizeMode="cover" />
                    <Text style={styles.title}>{`Mê Xỉu ${sizeTitle}`}</Text>
                    <Text numberOfLines={8} style={styles.description}>
                        Không phải thức uống cho kẻ nặng tình, Mê xỉu của KATINAT chính là thức uống dành cho người
                        mê mẩn vị cà phê Ban Mê đặc sản cùng sự hòa quyện tỉ lệ sữa ngọt thanh tinh tế. Với phương pháp 
                        pha Phin truyền thống. Mê Xỉu mang đến vị ngọt béo vừa phải, đậm đà tự hạt Robusta chất lượng và
                        vô cùng hợp gu "đô yếu" của giới mộ điệu cà phê. Thành phần: Sữa đặc, Sữa tươi, Cà phê phin, Đá
                    </Text>
                </View>
