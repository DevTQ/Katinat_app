...
const CheeseCoffe = () => {
    ...
    const [priceProductL, setPriceProductL] = useState(65000);
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.header}>
                    <ImageBackground source={require("../../../../assets/images/imageproducts/me_phomai.jpg")} style={styles.image} resizeMode="cover" />
                    <Text style={styles.title}>{`Mê Phô Mai ${sizeTitle}`}</Text>
                    <Text numberOfLines={8} style={styles.description}>
                        Nếu đã trót "mơi" vị cà phê sữa hài hòa cùng lớp kem mặn trong cà phê muối đặc trưng thì
                        Mê Phô Mai chính là sự lựa chọn số 1 dành cho bạn. Sựu cân bằng vị giác tinh tế của Cà Phê
                        Robusta đậm đà chất lượng đến từ vùng đất Ban Mê sánh mịn beo béo và vị ngọt nhẹ của mật ong
                        nguyên chất, chắc chắn sẽ khiến bạn đê "mê" quên lối về. Thành phần: Kem phô mai, Cà phê pha phin
                        ,Sữa đặc, Đá
                    </Text>
                </View>
