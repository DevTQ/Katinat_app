...
const YoungCoconutCoffe = () => {
    const navigation = useNavigation<NativeStackNavigationProp<RootStackParams>>();
    const [priceProductL, setPriceProductL] = useState(60000);
    const [priceProductS, setPriceProductS] = useState(49000);
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.header}>
                    <ImageBackground source={require("../../../../assets/images/imageproducts/meduanon.jpg")} style={styles.image} resizeMode="cover" />
                    <Text style={styles.title}>{`Mê Dừa Non ${sizeTitle}`}</Text>
                    <Text numberOfLines={8} style={styles.description}>
                        Mê Dừa Non chính thức chiếm trọn trái tim tín đồ cà phê chính hiệu khi mang đến sự kết hợp 
                        tuyệt diệu giữa Sữa Dừa Non thanh tươi, thơm béo, ngọt êm hòa quyện cùng hương vị cà phê sữa 
                        đậm đà sánh mịn, ngon bừng tỉnh mọi giác quan. Thành phần: Cốt dừa, Cà phê pha phin, Sữa đặc,
                        Đá
                    </Text>
                </View>
...
export default YoungCoconutCoffe;