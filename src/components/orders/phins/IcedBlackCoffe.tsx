...
const IcedBlackCoffe = () => {
    const navigation = useNavigation<NativeStackNavigationProp<RootStackParams>>();
    const [priceProductL, setPriceProductL] = useState(49000);
    const [priceProductS, setPriceProductS] = useState(35000);
    const [priceProductH, setPriceProductH] = useState(35000);
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.header}>
                    <ImageBackground source={require("../../../../assets/images/imageproducts/medenda.jpg")} style={styles.image} resizeMode="cover" />
                    <Text style={styles.title}>{`Mê Đen Đá ${sizeTitle}`}</Text>
                    <Text numberOfLines={8} style={styles.description}>
                        Đến giờ nạp Mê Đen Đá để tỉnh táo xử hết deadline ngày mới rồi Katies ơi. Không đơn thuần là vị cà
                        phê đen đậm đắng chỉ dành cho cánh mày râu, Mê đen đá được nghệ nhân Katinat nâng cấp, cho ra đời với
                        công thức dễ uống, đậm đà 100% hạt Robusta chất lượng từ thủ phủ cà phê Ban Mê, mang đến màu sắc và hương
                        vị ấn tượng, bừng tỉnh khi thưởng thức. Thành phần: Đường, Cà phê pha phin, Đá
                    </Text>
                </View>
