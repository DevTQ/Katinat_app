        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.header}>
                    <ImageBackground 
                        source={require('../../../../assets/images/imageproducts/latte-banana.jpg')} 
                        style={styles.image} 
                    />
                    <Text style={styles.title}>Latte Baba Nana (M)</Text>
                    <Text numberOfLines={6} style={styles.description}>
                        Mang đến một trải nghiệm mới lạ, Latte Baba Nana là sự hòa quyện giữa vị ngọt dịu của chuối
                        thanh mát, nên cà phê cân bằng và dòng sữa tươi thanh béo. Hương chuối thoang thoảng không chỉ
                        chứa đựng trong nền cà phê, mà còn nằm trong những miếng Thạch Chuối đậm vị.
                    </Text>
                </View>
                <View style={styles.body}>
                    <Text style={styles.sectionTitle}>Size</Text>
                    <TouchableOpacity style={styles.radioButtonContainer} activeOpacity={1}>
            ...
            <View style={styles.addCart}>
                ...
                <Text style={{ fontSize: 22, color:"#104358", fontWeight: 'bold' }}>
                    ...
                    <View style={{flexDirection: 'row', alignItems: "center"}}>
                        <TouchableOpacity style={{ marginRight: 10 }} activeOpacity={1} onPress={() => setNumberOfProduct("decrease")}>
                            <AntDesign name="minuscircleo" size={24} color="#104358" />
                        </TouchableOpacity>

                        <Text style={{ color: '#104358', fontSize: 15 }}>{numOfProduct}</Text>

                        <TouchableOpacity style={{ marginLeft: 10 }} activeOpacity={1} onPress={() => setNumberOfProduct("increase")}>
                            <AntDesign name="pluscircleo" size={24} color="#104358" />
                        </TouchableOpacity>
                    </View>
                </View>
                <TouchableOpacity style={styles.addCartButton} activeOpacity={1}
