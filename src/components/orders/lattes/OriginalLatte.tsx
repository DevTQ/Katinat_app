...
const OriginalLatte = () => {
    ...
    const [priceProduct, setPriceProduct] = useState(55000);
    ...
    const setNumberOfProduct = (action: "increase" | "decrease") => {
        setNumOfProduct(prevNum => {
            ...
            const newProductPrice = newNum * 55000;
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.header}>
                    <ImageBackground 
                        source={require('../../../../assets/images/imageproducts/latte-nguyen-ban.jpg')} 
                        style={styles.image} 
                    />
                    <Text style={styles.title}>Latte Nguyên Bản (M)</Text>
                    <Text numberOfLines={6} style={styles.description}>
                        Một sự kết hợp hoàn hảo giữa dòng Latte phong cách mới và dòng sữa tươi thanh béo,
                        Latte Nguyên Bản chiều lòng những ai trót mê sự nguyên bản. Chỉ cần một ngụm "Êm, Mê"
                        sẽ là sự khởi đầu của một ngày đầy năng lượng.
                    </Text>
                </View>
            ...
            <View style={styles.addCart}>
                ...
                <Text style={{ fontSize: 22, color:"#104358", fontWeight: 'bold' }}>
                    ...
                    <View style={{flexDirection: 'row', alignItems: "center"}}>
                        ...
                        <TouchableOpacity activeOpacity={1} style={{ marginLeft: 10 }} onPress={() => setNumberOfProduct("increase")}>
                            <AntDesign name="pluscircleo" size={24} color="#104358" />
                        </TouchableOpacity>
                    </View>
                </View>
                <TouchableOpacity activeOpacity={1} style={styles.addCartButton}
