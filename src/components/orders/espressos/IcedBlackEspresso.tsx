...
const IcedBlackEspresso = () => {
    const navigation = useNavigation<NativeStackNavigationProp<RootStackParams>>();
    const [priceProductL, setPriceProductL] = useState(44000);
    const [priceProductS, setPriceProductS] = useState(32000);
    const [priceProductH, setPriceProductH] = useState(32000);
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.header}>
                    <ImageBackground source={require("../../../../assets/images/imageproducts/Es-denda.jpg")} style={styles.image} resizeMode="cover" />
                    <Text style={styles.title}>{`Espresso Đen Đá ${sizeTitle}`}</Text>
                    ...
                    Cà phê Espresso KATINAT với sự kết hợp giữa hạt cà phê Arabica và Robusta lấy trực tiếp từ
                        ...
                        sức sống. Thành phần: đường, Cà phê pha máy, Đá
                    </Text>
                </View>
...
export default IcedBlackEspresso;