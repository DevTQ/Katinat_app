...
const IcedMilkEspresso = () => {
    const navigation = useNavigation<NativeStackNavigationProp<RootStackParams>>();
    const [priceProductL, setPriceProductL] = useState(47000);
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.header}>
                    <ImageBackground source={require("../../../../assets/images/imageproducts/Espresso-suada.jpg")} style={styles.image} resizeMode="cover" />
                    <Text style={styles.title}>{`Espresso Sữa Đá ${sizeTitle}`}</Text>
                    <Text numberOfLines={8} style={styles.description}>
                        Cà phê Espresso KATINAT với sự kết hợp giữa hạt cà phê Arabica và Robusta lấy trực tiếp từ
                        các vùng trồng cà phê trù phú tại việt nam. Hậu vị cà phê đắng nhẹ, thiên nhiên về hương
                        chocolate, được làm hoàn chỉnh từ phương pháp pha máy, vừa đủ cho một ngày bừng tỉnh đầy 
                        sức sống. Thành phần: Sữa đặc, Cà phê pha máy, Đá
                    </Text>
                </View>
...
export default IcedMilkEspresso;